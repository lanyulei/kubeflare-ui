...
declare namespace API {
  ...
  type GitOpsApplication = {
    ...
    image_repo?: string
    render_type: 'helm' | 'kustomize' | 'raw'
    status: GitOpsStatus
    created_at: string
    updated_at: string
  ...
  type GitOpsEnvironment = {
    id: string
    application_id: string
    name: string
    tier: GitOpsEnvironmentTier
    cluster_id: string
    namespace: string
    overlay_path: string
  ...
  type CreateGitOpsProviderParams = {
    name: string
    base_url: string
    token: string
  ...
  type UpdateGitOpsProviderParams = Omit<CreateGitOpsProviderParams, 'token'> & {
    token?: string
  }

  type CreateGitOpsRepositoryParams = {
    provider_id: string
    project_id: string
    name: string
    path: string
  ...
  type UpdateGitOpsRepositoryParams = CreateGitOpsRepositoryParams

  type CreateGitOpsApplicationParams = {
    repository_id: string
    name: string
    display_name: string
    description?: string
  ...
  type UpdateGitOpsApplicationParams = CreateGitOpsApplicationParams

  type CreateGitOpsEnvironmentParams = {
    application_id: string
    name: string
    tier: GitOpsEnvironmentTier
    cluster_id: string
  ...
  type UpdateGitOpsEnvironmentParams = CreateGitOpsEnvironmentParams

  type CreateGitOpsReleaseParams = {
    application_id: string
    environment_id: string
    title: string
    source_ref?: string
  ...
  type GitOpsReleaseActionParams = {
    comment?: string
  }

  type GitOpsRollbackReleaseParams = {
    reason?: string
  }

  type GitOpsProviderTestResult = {
    provider_id: string
    reachable: boolean
    message: string
    version?: string
