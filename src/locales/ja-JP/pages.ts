export default {
  ...
  'pages.login.tip': 'システムで発行されたアカウントでログインしてください。',
  ...
  'pages.system.users.title': 'ユーザー管理',
  'pages.system.users.username': 'ユーザー名',
  'pages.system.users.nickname': '表示名',
  'pages.system.users.email': 'メール',
  'pages.system.users.phone': '電話番号',
  'pages.system.users.status': '状態',
  'pages.system.users.status.enabled': '有効',
  'pages.system.users.status.disabled': '無効',
  'pages.system.users.updatedAt': '更新日時',
  'pages.system.users.option': '操作',
  'pages.system.users.edit': '編集',
  'pages.system.users.delete': '削除',
  'pages.system.users.delete.confirm': 'このユーザーを削除しますか？',
  'pages.system.users.delete.success': 'ユーザーを削除しました。',
  'pages.system.users.setupToken': '初期化トークン生成',
  'pages.system.users.setupToken.title': 'パスワード初期化トークン',
  'pages.system.users.create': 'ユーザー作成',
  'pages.system.users.create.success': 'ユーザーを作成しました。',
  'pages.system.users.edit.success': 'ユーザーを更新しました。',
  'pages.system.users.password': 'パスワード',
  'pages.system.users.password.optional':
    '新しいパスワード（空欄で変更しない）',
  'pages.system.users.password.confirm': 'パスワード確認',
  'pages.system.users.avatar': 'アバター',
  'pages.system.users.avatar.upload': 'アバターをアップロード',
  'pages.system.users.remark': '備考',
  ...
  'pages.account.settings.avatar': 'アバター',
  'pages.account.settings.avatar.upload': 'アバターをアップロード',
