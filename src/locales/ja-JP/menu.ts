export default {
  ...
  'menu.systemAI': 'AI 管理',
  'menu.systemAI.systemAIAgent': 'Agent 一覧',
  'menu.systemAI.systemAIRuns': 'Runs',
  'menu.systemAI.systemAIRuntime': 'Runtime Status',
  'menu.systemAI.systemAIEvaluation': '評価ダッシュボード',
  'menu.systemAI.systemAILearning': 'Learning Data',
  'menu.systemAI.systemAITool': 'ツール管理',
  'menu.systemAI.systemAISkill': 'スキル管理',
  'menu.gitops.systemAI': 'AI 管理',
  'menu.gitops.systemAI.systemAIAgent': 'Agent 一覧',
  'menu.gitops.systemAI.systemAIRuns': 'Runs',
  'menu.gitops.systemAI.systemAIRuntime': 'Runtime Status',
  'menu.gitops.systemAI.systemAIEvaluation': '評価ダッシュボード',
  'menu.gitops.systemAI.systemAILearning': 'Learning Data',
  'menu.gitops.systemAI.systemAITool': 'ツール管理',
  'menu.gitops.systemAI.systemAISkill': 'スキル管理',
  'menu.login': 'ログイン',
  'menu.register': '登録',
