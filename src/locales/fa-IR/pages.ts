export default {
  ...
  'pages.admin.users.title': 'مدیریت کاربران',
  'pages.admin.users.username': 'نام کاربری',
  'pages.admin.users.nickname': 'نام نمایشی',
  'pages.admin.users.email': 'ایمیل',
  'pages.admin.users.phone': 'تلفن',
  'pages.admin.users.role': 'نقش',
  'pages.admin.users.status': 'وضعیت',
  'pages.admin.users.status.enabled': 'فعال',
  'pages.admin.users.status.disabled': 'غیرفعال',
  'pages.admin.users.updatedAt': 'بروزرسانی',
  'pages.admin.users.option': 'اقدامات',
  'pages.admin.users.edit': 'ویرایش',
  'pages.admin.users.delete': 'حذف',
  'pages.admin.users.delete.confirm': 'این کاربر حذف شود؟',
  'pages.admin.users.delete.success': 'کاربر حذف شد.',
  'pages.admin.users.setupToken': 'توکن راه‌اندازی',
  'pages.admin.users.setupToken.title': 'توکن تنظیم رمز عبور',
  'pages.admin.users.create': 'ایجاد کاربر',
  'pages.admin.users.create.success': 'کاربر با موفقیت ایجاد شد.',
  'pages.admin.users.edit.success': 'کاربر با موفقیت بروزرسانی شد.',
  ...
  'pages.account.settings.avatar': 'آدرس آواتار',
